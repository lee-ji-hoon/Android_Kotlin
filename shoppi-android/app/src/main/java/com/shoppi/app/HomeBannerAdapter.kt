...
class HomeBannerAdapter : ListAdapter<Banner, HomeBannerAdapter.HomeBannerViewHolder>(BannerDiffCallback()) {
    ...
    class HomeBannerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val bannerDetailBrandLabelTextView = view.findViewById<TextView>(R.id.tv_banner_detail_product_label)
        private val bannerDetailDiscountLabelTextView = view.findViewById<TextView>(R.id.tv_banner_detail_product_label)
